const translations = {
    es: {
        ...
        exp_pers_ai_p1: "He hablado mucho del desarrollo de aplicaciones, scripts y addons, así que es el momento de desvelar el velo. No soy programador, aunque sí informático desde que tuve mi primer ordenador en 1995, llegando a trabajar profesionalmente. He pasado por Windows, macOS y Linux, siendo este último mi sistema principal desde hace años. Me apasiona la informática y parte de mi afición es montar aplicaciones mediante Docker en mi servidor local, algo que ya hacía antes de la llegada de la IA.",
