window.translations = {
    ...
    en: {
        ...
        resumen_render_text: "Drawing from my extensive background in photography and audiovisual production, I build lighting setups, framing, and procedural materials to produce static renders and realistic animations.",
        ...
        about_p1: "My relationship with the audiovisual world began when I was 14 years old, when the first camera arrived at my house. My first steps were creating personal videos and documenting every trip, then filming skaters for their brand-sponsored video profiles, and later working as a freelancer directing and editing music videos, festivals, and tours.",
